...
The development process follows a *GUI-first approach*, where interface design decisions guide implementation.
  1. GUI Design Phase
      > Identification of primary user flows (browsing courses, admissions, contact).
      > Creation of layout wireframes focusing on visual hierarchy
      > Selection of color schemes and typography suitable for educational platforms
